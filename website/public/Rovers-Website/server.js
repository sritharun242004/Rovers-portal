...
app.get('/api/health', (req, res) => {
  res.json({ 
    status: 'OK', 
    message: 'Rovers Email Service is running',
    timestamp: new Date().toISOString()
  });
});

app.listen(PORT, () => {
  console.log(`🚀 Rovers Email Server running on port ${PORT}`);
  console.log(`📧 Email service ready - sending to jeelu@rovers.life`);
});
