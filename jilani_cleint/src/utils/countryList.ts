/**
 * A mapping of country codes to their full country names
 * Used for form submissions where we need to store both the country code
 * and the full country name
 */
 ...
 * @param code The country code (e.g., 'US', 'IN')
 ...
 * @param name The country name to look for
...
export const getCountryCode = (name: string): string | null => {
  ...
  const entry = entries.find(([_, countryName]) => countryName === name);
